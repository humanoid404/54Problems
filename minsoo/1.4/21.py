...
#     if S == 'kor':
#         Month1 = D1[int(input('Please enter the number of the month: '))]
#         print(f'The name of the month is {Month1}.')
#         break
#     elif S == 'eng':
#         Month2 = D2[int(input('Please enter the number of the month: '))]
#         print(f'The name of the month is {Month2}.')
#         break
#     else:
#         print('Invalid')
